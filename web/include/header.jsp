...
<header>
    <div class="container-fluid sticky-top">
        <nav class="navbar navbar-expand-md navbar-light ">
            <div class="container">
                <a class="navbar-brand" href="index.jsp"><img src="../img/homepage/logo_jp2.png"
                                                              alt="United_Barber_Salon.png"></a>
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto">
                        <a id="index" class="button button1 nav-iStem nav-link" href="index.jsp">Home <span
                                class="sr-only">(current)</span></a>
                        <a id="booking" class="button button1 nav-item nav-link" href="booking.jsp">Book!</a>
                        <a id="shop" class="button button1 nav-item nav-link" href="shop.jsp">Shop</a>
                        <a id="contact" class="button button1 nav-item nav-link" href="contact.jsp">Contact</a>
                        <a class="basket" href="#"><i class="fas fa-shopping-basket"></i></a>
                        <a class="login" href="#loginModal"><i class="fas fa-user"></i></a>
                        <!--                        <div class="btn-group">
